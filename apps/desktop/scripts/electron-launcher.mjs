// This file mostly exists because we want dev mode to say "DTRP T3 (Dev)" instead of "electron"
...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "DTRP T3 (Dev)" : "DTRP T3 (Alpha)";
export const APP_BUNDLE_ID = isDevelopment
  ? `com.demontimerp.t3code.dev.${devBundleIdSuffix || "local"}`
  : "com.demontimerp.t3code";
const APP_PROTOCOL_SCHEMES = isDevelopment ? ["dtrp-t3-dev"] : ["dtrp-t3"];
